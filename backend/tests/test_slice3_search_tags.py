...
def create_box(client, headers, warehouse_id, name, parent_box_id=None):
    ...
    res = client.post(f"/api/warehouses/{warehouse_id}/boxes", json=payload, headers=headers)
    return res.json()


def create_item(client, headers, warehouse_id, payload):
    res = client.post(f"/api/warehouses/{warehouse_id}/items", json=payload, headers=headers)
...
def test_search_relevance_path_and_tag_cloud(client):
    ...
    cloud = client.get(f"/api/warehouses/{warehouse_id}/tags/cloud", headers=headers)
    ...
    list_tags = client.get(f"/api/warehouses/{warehouse_id}/tags", headers=headers)
